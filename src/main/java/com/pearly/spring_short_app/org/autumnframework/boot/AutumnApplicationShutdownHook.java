...
package com.pearly.spring_short_app.org.autumnframework.boot;
 ...
 * @author Brian Clozel
 */
class AutumnApplicationShutdownHook implements Runnable {

    private static final int SLEEP = 50;

    private static final long TIMEOUT = TimeUnit.MINUTES.toMillis(10);

    private static final Log logger = LogFactory.getLog(AutumnApplicationShutdownHook.class);
    ...
    void registerApplicationContext(ConfigurableApplicationContext context) {
        ...
        synchronized (AutumnApplicationShutdownHook.class) {
            assertNotInProgress();
    ...
    void deregisterFailedApplicationContext(ConfigurableApplicationContext applicationContext) {
        synchronized (AutumnApplicationShutdownHook.class) {
            ...
            AutumnApplicationShutdownHook.this.contexts.remove(applicationContext);
        }
    }
    ...
    private void assertNotInProgress() {
        Assert.state(!AutumnApplicationShutdownHook.this.inProgress, "Shutdown in progress");
    }
    ...
    private final class Handlers implements SpringApplicationShutdownHandlers, Runnable {
        ...
        @Override
        public void run() {
            AutumnApplicationShutdownHook.this.run();
            AutumnApplicationShutdownHook.this.reset();
        }
    ...
    private final class ApplicationContextClosedListener implements ApplicationListener<ContextClosedEvent> {
        ...
        public void onApplicationEvent(ContextClosedEvent event) {
            ...
            synchronized (AutumnApplicationShutdownHook.class) {
                ...
                AutumnApplicationShutdownHook.this.contexts.remove(applicationContext);
                AutumnApplicationShutdownHook.this.closedContexts
