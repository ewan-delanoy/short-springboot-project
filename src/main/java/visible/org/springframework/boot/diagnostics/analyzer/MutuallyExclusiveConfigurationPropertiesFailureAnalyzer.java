...
package visible.org.springframework.boot.diagnostics.analyzer;
...
import visible.org.springframework.boot.context.properties.source.MutuallyExclusiveConfigurationPropertiesException;
import visible.org.springframework.boot.diagnostics.AbstractFailureAnalyzer;
import visible.org.springframework.boot.diagnostics.FailureAnalysis;
import visible.org.springframework.boot.diagnostics.FailureAnalyzer;
import visible.org.springframework.boot.origin.Origin;
import visible.org.springframework.boot.origin.OriginLookup;
