...
import visible.org.springframework.boot.context.properties.bind.BindConstructorProvider;
...
public final class ConfigurationPropertiesBean {
	...
	private static final visible.org.springframework.boot.context.properties.bind.BindMethod JAVA_BEAN_BIND_METHOD = //
			visible.org.springframework.boot.context.properties.bind.BindMethod.JAVA_BEAN;

	private static final visible.org.springframework.boot.context.properties.bind.BindMethod VALUE_OBJECT_BIND_METHOD = //
			visible.org.springframework.boot.context.properties.bind.BindMethod.VALUE_OBJECT;
	 ...
	 */
	static visible.org.springframework.boot.context.properties.bind.BindMethod deduceBindMethod(Class<?> type) {
	 ...
	 * @return the bind method to use
	 */
	static visible.org.springframework.boot.context.properties.bind.BindMethod deduceBindMethod(Bindable<Object> bindable) {
		return deduceBindMethod(BindConstructorProvider.DEFAULT.getBindConstructor(bindable, false));
	}

	private static visible.org.springframework.boot.context.properties.bind.BindMethod deduceBindMethod(
