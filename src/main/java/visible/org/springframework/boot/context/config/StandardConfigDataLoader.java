...
import visible.org.springframework.boot.context.config.ConfigData.Option;
import visible.org.springframework.boot.context.config.ConfigData.PropertySourceOptions;
import visible.org.springframework.boot.origin.Origin;
import visible.org.springframework.boot.origin.OriginTrackedResource;
