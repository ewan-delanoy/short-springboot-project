 ...
 * ready to service requests. The source of the event is the {@link AutumnApplication}
...
public class ApplicationReadyEvent extends SpringApplicationEvent {
	 ...
	 * @since 2.6.0
	 */
	public ApplicationReadyEvent(AutumnApplication application, String[] args, ConfigurableApplicationContext context,
