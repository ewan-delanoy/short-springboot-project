...
package visible.org.springframework.boot.context.logging;
...
import visible.org.springframework.boot.context.event.ApplicationEnvironmentPreparedEvent;
import visible.org.springframework.boot.context.event.ApplicationFailedEvent;
import visible.org.springframework.boot.context.event.ApplicationPreparedEvent;
import visible.org.springframework.boot.context.event.ApplicationStartingEvent;
...
import visible.org.springframework.boot.logging.LogFile;
import visible.org.springframework.boot.logging.LogLevel;
import visible.org.springframework.boot.logging.LoggerGroup;
import visible.org.springframework.boot.logging.LoggerGroups;
import visible.org.springframework.boot.logging.LoggingInitializationContext;
import visible.org.springframework.boot.logging.LoggingSystem;
import visible.org.springframework.boot.logging.LoggingSystemProperties;
...
public class LoggingApplicationListener implements GenericApplicationListener {
	...
	private static final Class<?>[] SOURCE_TYPES = { AutumnApplication.class, ApplicationContext.class };
	...
	private void onApplicationEnvironmentPreparedEvent(ApplicationEnvironmentPreparedEvent event) {
		AutumnApplication springApplication = event.getSpringApplication();
	...
	void registerShutdownHook(Runnable shutdownHandler) {
		AutumnApplication.getShutdownHandlers().add(shutdownHandler);
	}
